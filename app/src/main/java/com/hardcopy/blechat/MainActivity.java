...
public class MainActivity extends FragmentActivity implements ActionBar.TabListener, IFragmentListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final int PERMISSION_REQUEST_CODE_ = 1;
		final int PERMISSION_REQUEST_CODE__ = 1;
		...
		if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
			...
			if (checkSelfPermission(Manifest.permission.ACCESS_COARSE_LOCATION)
				...
				Log.d("permission", "ACCESS_COARSE_LOCATION");
				String[] permissions = {Manifest.permission.ACCESS_COARSE_LOCATION};

				requestPermissions(permissions, PERMISSION_REQUEST_CODE_);
